...
public abstract class Test {/*
    ...
    private static final String DEFAULT_FILE_PATH = "D:";
    ...
    *//**
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
       ...
       // System.out.println(Test.resize(140, 140, null, new URL("http://www.open-open.com/lib/images/logo.jpg")));
        Test.resize(400, 228, ImageQuality.high.getQuality(), null, ImageIO.read(new File("D:/Tulips.jpg")));
    }
*/}
